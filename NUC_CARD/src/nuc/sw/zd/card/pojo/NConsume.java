...
public class NConsume {
    ...
    public NConsume(Integer outid, Integer acccode, String opdt, float opfar, String termname, String dpname1, String dpname2, String dpname3, String dpname4) {
        this.outid = outid;
        this.opdt=opdt;
    ...
    public void setOpfar(float opfar) {
        this.opfar = opfar;
    }

    public float getOpfar() {
        return opfar;
    }
