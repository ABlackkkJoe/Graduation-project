...
public class EmailTest {
    ...
    public static final String ACCOUT = "15035391262@163.com";
    public static final String PWD = "zd19970602";
    ...
    public static MimeMessage createEmail(Session session) throws Exception {
        ...
        InternetAddress receiveAddress = new InternetAddress(
                "1071102546@qq.com", "test", "utf-8");
        // 设置邮件接收方
        msg.setRecipient(RecipientType.TO, receiveAddress);
        // 设置邮件标题
        msg.setSubject("提醒：一卡通消费预警", "utf-8");
        msg.setText("测试版。同学，你好。这一学期您未使用过一卡通进行任何消费。请检查一卡通状况，谢谢合作。");
        // 设置显示的发件时间
