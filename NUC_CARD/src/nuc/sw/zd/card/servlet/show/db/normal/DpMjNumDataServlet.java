package nuc.sw.zd.card.servlet.show.db.normal;
...
@WebServlet("/normal_mjNum")
public class DpMjNumDataServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select dpname1,dpname2,count(distinct outid) count from tb_n_attend_consume where dpname1='软件学院' group by dpname1,dpname2;";
        ResultSet set = null;
        Statement stmt = null;
