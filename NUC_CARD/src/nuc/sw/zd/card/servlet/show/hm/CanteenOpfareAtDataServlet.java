...
@WebServlet("/opfareatnum")
public class CanteenOpfareAtDataServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select  opfare_sum as opfare," +
                "count(opfare_sum) as count " +
                "from tb_a_attend_consume where acccode=210 GROUP BY opfare ;";
