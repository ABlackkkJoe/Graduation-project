...
@WebServlet("/srtwo")
public class SrTwoDataServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select termname, sum(OPFARE_SUM) as opfare  " +
                "from tb_n_attend_consume  where TERMNAME like '%浴0%'" +
                "and  ACCCODE=211 group by termname;\n";
