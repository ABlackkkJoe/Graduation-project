...
public class GetThreeDataServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("三大" + userCode);
        String sql = "select OUTID,ACCCODE,sum(OPFARE_sum) opfare " +
                "from tb_n_attend_consume where outid="+userCode+" group by outid , acccode;";
