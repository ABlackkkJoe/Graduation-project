...
@WebServlet("/normal_stuNum")
public class DpNumDataServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select count(distinct outid) count,dpname1 from tb_n_attend_consume group by dpname1;";
        ResultSet set = null;
        Statement stmt = null;
