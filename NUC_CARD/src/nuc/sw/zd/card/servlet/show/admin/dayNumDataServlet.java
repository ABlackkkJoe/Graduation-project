package nuc.sw.zd.card.servlet.show.admin;
...
@WebServlet("/daynum")
public class dayNumDataServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "SELECT DATE_FORMAT(CAST(opdt as DATE),'%m%d') as dt,\n" +
                "COUNT(DAYOFYEAR(CAST(opdt as date))) as COUNT \n" +
