package nuc.sw.zd.card.servlet.show.dp.attend;
...
@WebServlet("/ave")
public class DpAveDataServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select A.dpname1 dpname1,su opfare,nu count,su/nu ave from\n" +
                "  (select sum(OPFARE_sum) as su ,dpname1 from tb_a_attend_consume group by dpname1) A\n" +
                "  inner join\n" +
                "  (select count(distinct outid) as nu ,dpname1 from tb_a_attend_consume group by dpname1) B\n" +
                "  on\n" +
                "A.dpname1=B.dpname1;";
        ResultSet set = null;
        Statement stmt = null;
