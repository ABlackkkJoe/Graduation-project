...
public class GetLibraryDataServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select outid,acccode,termname,sum(OPFARE_sum) opfare from tb_n_attend_consume" +
                " WHERE OUTID="+userCode+" and acccode=222 group by outid,acccode,termname;";
