...
@WebServlet("/srmonop10")
public class SrMonOpTenDataServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select  outid,sum(opfar) as opfare " +
                "from tb_n_attend_consume_date where acccode=211 \n" +
                "and EXTRACT(MONTH FROM CAST(OPDT as date)) = 10 GROUP BY OUTID ;";
