package cn.smbms.servlet.dpment_user;

import cn.smbms.pojo.Role;
import cn.smbms.pojo.User;
import cn.smbms.service.role.RoleService;
import cn.smbms.service.role.RoleServiceImpl;
import cn.smbms.service.user.dpment_UserService;
import cn.smbms.service.user.dpment_UserServiceImpl;
...
public class dpment_UserServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (null != method && method.equals("add")) {                   // 添加操作
            ...
            this.getUserById(request, response, request.getContextPath() + "/jsp/userview.jsp");
        } else if (null != method && method.equals("modify")) {         // 修改用户信息
            this.getUserById(request, response, request.getContextPath() + "/jsp/usermodify.jsp");
    ...
    private void add(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 进行底层数据操作
        dpment_UserServiceImpl userService = new dpment_UserServiceImpl();
    ...
    private void query(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 查询总数量
        dpment_UserService userService = (dpment_UserService) new dpment_UserServiceImpl();
        ...
        request.getRequestDispatcher(request.getContextPath() + "/jsp/dpment_userlist.jsp").forward(request, response);
    }
    ...
    private void modify(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (userService.modfiy(user)) {   // 修改成功, 跳到列表界面
            ...
            request.getRequestDispatcher(request.getContextPath() + "/jsp/userModify.jsp").forward(request, response);
        }
    }
...
//            resultMap.put("msg", "session信息过期");
    ...
    private void updatePwd(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 跳转到修改界面
        request.getRequestDispatcher(request.getContextPath() + "/jsp/pwdmodify.jsp").forward(request, response);
    }
}
