...
@WebServlet("/canteenhour")
public class CtHrDataServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select EXTRACT(HOUR_MINUTE FROM CAST(opdt AS DATETIME)) as dt, \n" +
                "count(EXTRACT(HOUR_MINUTE FROM CAST(opdt AS DATETIME))) as count \n" +
                "from tb_n_attend_consume_date where acccode=210 group by dt;";
