...
@WebServlet("/major_num")
public class DpMNDataServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select acccode,sum(OPFARE_sum) opfare,dpname1,dpname2,dpname4 " +
                "from tb_n_attend_consume " +
                "where dpname1='" +school+
                "' and DPNAME2='"  +major+
                "' group by acccode,dpname1,dpname2,dpname4";
        ResultSet set = null;
        Statement stmt = null;
