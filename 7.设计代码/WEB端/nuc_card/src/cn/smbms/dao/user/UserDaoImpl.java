...
public class UserDaoImpl implements UserDao {
    ...
    public int add(Connection connection, User user) throws Exception {
        ...
        int updateRows = 0;
        if (null != connection) {
            String sql = "insert into card_user(userCode, userName, userPassword, gender, birthday, phone, address," +
    ...
    public User getLoginUser(Connection connection, String userCode) throws Exception {
        ...
        User user = null;
        if (null != connection) {
            String sql = "select * from card_user where userCode = ?";
    ...
    public List<User> getUserList(Connection connection, String userName, int userRole, int currentPageNo, int pageSize) throws Exception {
        ...
        if (null != connection) {
            ...
            String sql = "select u.*, roleName from card_user u, card_role r where u.userRole = r.id";
            if (!userName.isEmpty()) {
    ...
    public int getUserCount(Connection connection, String userName, int userRole) throws Exception {
        ...
        if (null != connection) {
            ...
            String sql = "select count(1) as count from card_user u, card_role r where u.userRole = r.id";
            if (!userName.isEmpty()) {
                sql += " and u.userName like ?";
                list.add("%" + userName + "%");
            }
    ...
    public int deleteUserById(Connection connection, Integer delId) throws Exception {
        ...
        int flag = 0;
        if (null != connection) {
            String sql = "delete from card_user where id = ?";
            Object[] params = {delId};
    ...
    public User getUserById(Connection connection, String id) throws Exception {
        ...
        ResultSet rs = null;
        if (null != connection) {
            String sql = "select u.*, roleName from card_user u, card_role r where u.id = ? and u.userRole = r.id";
            Object[] params = {id};
    ...
    public int modify(Connection connection, User user) throws Exception {
        ...
        PreparedStatement pstm = null;
        if (null != connection) {
            String sql = "update card_user set userName = ?, gender = ?, address = ?, birthday = ?, phone = ?, birthday = ?, userRole = ?," +
    ...
    public int updatePwd(Connection connection, int id, String pwd) throws Exception {
        ...
        PreparedStatement pstm = null;
        if (null != connection) {
            String sql = "update card_user set userPassword = ? where id = ?";
