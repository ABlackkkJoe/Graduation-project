...
<div class="right">
    ...
    <div class="right">
        <div class="wFont">
            ...
            <a href="${pageContext.request.contextPath }/images/day.png" style="font-size: larger">详情图查看</a><br/>


            <h3>2，查看男女淋浴POS机收益分析图得知，女浴收益相对高，符合女生日常洗澡频率。</h3>
            <h3>建议：女生澡堂增大日供水量或适当增加花洒数量，以避免供不应求。</h3>
            <a href="${pageContext.request.contextPath }/images/women.png" style="font-size: larger">详情图查看</a><br/>



            <h3>3，查看POS机刷卡次数和收益额分析图得知，每一pos机收益是均衡的，不存在较大反差。</h3>
            <a href="${pageContext.request.contextPath }/images/ratio.png" style="font-size: larger">详情图查看</a><br/>

            <h3>4，查看各个POS机收益分析图得知，pos机收益是有较大差距的。</h3>
            <h3>建议：对于收益较低的POS机，定期检查花洒质量或周围环境问题，以改善收益同时方便学生。</h3>
            <a href="${pageContext.request.contextPath }/images/insterest.png" style="font-size: larger">详情图查看</a> <br>
