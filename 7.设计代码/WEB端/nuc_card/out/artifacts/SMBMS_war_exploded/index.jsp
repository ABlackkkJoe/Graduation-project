				...
				<div class="col-md-8 header-right">
					...
					<ul class="address">
						...
						<li>
							<ul class="address-text">
								<li><b>WEBSITE </b></li>
								<li><a href="http://localhost:8080/login.jsp">http://localhost:8080/login.jsp</a></li>
							</ul>
						</li>
					</ul>
				</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<div class="menu">
					<ul class="nav navbar">
						...
						<li><a href="http://localhost:8080/login.jsp">系统登录</a></li>
	...
	<div id="about" class="about">
		<div class="container">
			...
			<div class="col-md-8 about-left">
				<p>1.课题背景:</p>
				<p>&nbsp;&nbsp;随着数字化时代的发展，全国各个高校建立了属于自己的校园一卡通系统。每位学生每天会使用一卡通在校园内进行各类刷卡，进而产生大量的刷卡记录。但是目前各个高校使用的校园一卡通系统只是针对师生的各种业务需求实现了各种应用，缺乏的是对刷卡记录进行有效的分析，该课题是在此背景下对大学生一卡通数据进行了研究与实现，为学校决策提供充分的科学依据，使管理更规范、更有针对性，同时提高学校各个机构调整和改善的合理性。</p><br>
				<p>2.课题工作:</p>
				<p>&nbsp;&nbsp;采用B/S模式、微信小程序完成校园一卡通数据分析系统，使用户能够利用此系统清晰的了解该系统的设计思想和一卡通数据的分析情况，为个人生活和工作带来便利。系统提供如下功能：用户能够通过WEB查看系统；各个角色的用户可以在登录界面进行登录、可以从时间维度、消费类型与水平维度、POS机维度、性别维度、年级专业班级维度等对数据可视化、修改个人信息；系统管理员可对用户做增删改查操作；该系统实现者对一卡通数据预处理,将一卡通数据提交给Hadoop集群实现存储和分析,并通过不同维度对数据可视化展示。</p>

			</div>
			<div class="col-md-4 about-right">
				<ul>
					<h5></h5>
					<li><span class="glyphicon glyphicon-menu-right"></span> 高层决策者</li>
		...
		<div class="container">
			...
			<div class="work-info"> 
				...
				<div class="col-md-6 work-right"> 
					<span style="font-size: larger"> Hadoop集群:</span>
					<br>
					<span>利用HDFS技术实现一卡通数据的存储、Hive和MySQL技术实现一卡通数据的统计和分析</span>
</div>
				<div class="clearfix"> </div>
			</div>
			<div class="work-info"> 
				...
				<div class="col-md-6 work-left work-left2"> 
					<span style="font-size: larger">WEB端MVC模式:</span>
					<br>
					<span>实现后台页面管理模块</span>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="work-info"> 
				...
				<div class="col-md-6 work-right"> 
					<span style="font-size: larger"> K-MEANS算法:</span>
					<br>
					<span>利用轮廓系数法和肘部法确定最佳k值，进而通过K-means聚类算法分析一卡通数据，得出3类消费水平群体。</span>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="work-info">
				...
				<div class="col-md-6 work-right">
					<span style="font-size: larger"> 等距离离散化:</span>
					<br>
					<span>等距离离散化分析一卡通数据，得出消费数量与消费性别关系。</span>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="work-info"> 
				...
				<div class="col-md-6 work-left work-left2"> 
					<span style="font-size: larger"> Echarts、Matplotlib: </span>
					<br>
					<!--<p>-->
					<span>Matplotlib和Echarts对分析结果进行可视化。 </span>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="work-info"> 
				...
				<div class="col-md-6 work-right"> 
					<span style="font-size: larger">前后台交互:</span>
					<br>
					<span>移动端微信一卡通小程序模拟用户行为并与WEB端相结合。</span>
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
			...
			<div class="contact-row">
				<div class="col-md-6 contact-right">
					<div class="address-left">
						<p>快速链接：<br> <a href="http://localhost:8080/login.jsp">http://localhost:8080/login.jsp</a> </p>
					</div>
