...
consume_data2=consume_data.loc[consume_data["label"] == 2]
#consume_data3=consume_data.loc[consume_data["label"] == 3]
...
plt.scatter(consume_data2['count'],consume_data2['opfare'],50,color='#00FE00',marker='o',linewidth=2,alpha=0.8)
#plt.scatter(consume_data3['count'],consume_data3['opfare'],50,color='#FF00EE',marker='+',linewidth=2,alpha=0.8)
